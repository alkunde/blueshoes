...
import br.com.mobiletkbrazil.blueshoes.domain.User
import br.com.mobiletkbrazil.blueshoes.util.NavMenuItemDetailsLookup
...
class MainActivity :
  ...
  override fun onSaveInstanceState(outState: Bundle?) {
    ...
    /**
     * Para manter o item do menu gaveta selecionado caso
